...
public class MainActivity extends AppCompatActivity {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && intent.getAction() != null) {
                ...
                if ("online.luna.TIMER_UPDATED".equals(action)) {
                    ...
                    if (errorCode == 410) {
                        if (tvStatus != null) tvStatus.setText("Set-up Your Access Token in Our Website");
                        if (btnStart != null) {
                            btnStart.setVisibility(View.VISIBLE);
                            btnStart.setText("OPEN ACCESS PANEL WEBSITE");
    ...
    // =============== MODIFIED: Create Config with Your Format ================
    ...
    private void deleteLocalConfigFile() {
        ...
        try {
            ...
            Toast.makeText(this, "Error deleting config!", Toast.LENGTH_SHORT).show();
        }
    }

    // =============== MODIFIED: Start/Stop uses config ================
