...
public class MainActivity extends AppCompatActivity {
    ...
    // =============== FIXED: Compact JSON without spaces and escaped slashes ================
    private void createLocalConfigFile() {
        ...
        try {
            ...
            // Manually create compact JSON string (no spaces, no escaped slashes)
            String configContent = "{\"verAddr\":\"" + CONFIG_VER_ADDR + "\",\"serverLoginUrl\":\"" + CONFIG_SERVER_BASE + jwtToken + "/\"}";
